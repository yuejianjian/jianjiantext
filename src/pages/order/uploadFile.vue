<template>
  <div id="uploadFile">
    ...
    <ul class="upImgList">
      <li v-for="(imgItem,idx) in imgList">
...
export default {
  ...
  methods:{
    ...
    changeImage(e) {
      ...
      axios({
        method: 'post',
        url: '/h5/kxdh/file/upload/uploadFile.do',
        baseURL: apiUrl,
        data: fd,
        headers: {
          'Content-Type': 'multipart/form-data',
          // 'accessToken':'91131e48d06713e5ca04abb7100c27478dfa'
        }
      }).then(response => {
      ...
      //   this.$toast("上传图片错误!");
      // }, false);
      // xhr.open("POST", 'http://wx.dh.kxp1688.com:8089/h5/kxdh/file/upload/uploadFile.do');
